...
<<<<<<< HEAD
    blog: `${(
      <>
        ...
        in wood is likely.[10] Gupta Architecture For reasons that are not
        entirely clear, for the most part the Gupta period represented a hiatus
        in Indian rock-cut architecture, with the first wave of construction
        finishing before the empire was assembled, and the second wave beginning
        in the late 5th century, after it ended. This is the case, for example,
        at the Ajanta Caves, with an early group made by 220 CE at the latest,
        and a later one probably all after about 460.[19] Instead, the period
        has left almost the first surviving free-standing structures in India,
        in particular, the beginnings of Hindu temple architecture. As Milo
        Beach puts it: "Under the Guptas, India was quick to join the rest of
        the medieval world in a passion for housing precious objects in stylized
        architectural frameworks",[20] the "precious objects" being primarily
        the icons of gods. The most famous remaining monuments in a broadly
        Gupta style, the caves at Ajanta, Elephanta, and Ellora (respectively
        Buddhist, Hindu, and mixed including Jain) were in fact produced under
        other dynasties in Central India, and in the case of Ellora after the
        Gupta period, but primarily reflect the monumentality and balance of
        Guptan style. Ajanta contains by far the most significant survivals of
        painting from this and the surrounding periods, showing a mature form
        which had probably had a long development, mainly in painting
        palaces.[21] The Hindu Udayagiri Caves actually record connections with
        the dynasty and its ministers,[22] and the Dashavatara Temple at Deogarh
        is a major temple, one of the earliest to survive, with important
        sculpture.[23] Examples of early North Indian Hindu temples that have
        survived after the Udayagiri Caves in Madhya Pradesh include those at
        Tigawa (early 5th century),[24] Sanchi Temple 17 (similar, but
        respectively Hindu and Buddhist), Deogarh, Parvati Temple, Nachna
        (465),[25] Bhitargaon, the largest Gupta brick temple to survive,[26]
        and Lakshman Brick Temple, Sirpur (600–625 CE). Gop Temple in Gujarat
        (c. 550 or later) is an oddity, with no surviving close comparator.[27]
        There are a number of different broad models, which would continue to be
        the case for more than a century after the Gupta period, but temples
        such as Tigawa and Sanchi Temple 17, which are small but massively built
        stone prostyle buildings with a sanctuary and a columned porch, show the
        most common basic plan that continues today. Both of these have flat
        roofs over the sanctuary, which would become uncommon by about the 8th
        century. The Mahabodhi Temple, Bhitargaon, Deogarh and Gop already all
        show high superstructures of different shapes.[28] The Chejarla
        Kapoteswara temple demonstrates that free-standing chaitya-hall temples
        with barrel roofs continued to be built, probably with many smaller
        examples in wood.[29]
      </>
    )}`,
  },
  {
    title: "Carpet Area ,Built up Area and Super Built Area",
...
>>>>>>> ac1c90507f717364e28eeb5d0dfad517a39a00d3
  },
  {
...
<<<<<<< HEAD
    blog: (
      <>
        ...
        residential buildings have different FAR FAR = Gross plot Area/area of
        plot
        <br />
        ...
        FAR of 1.25 is represented as FSI of 125%. Example:If your plot area is
        1000 sqft. and the FAR allowed in your city is 1.5% then your total
        built up area cannot exceed 1000x1.5= 1500 sqft. What is Premium FSI? If
        you have a road with a width of 30-40 ft. you will be able to build 20 %
        more than the permissible FSI, on payment of the required premium FSI
        charges. • 30 – 40 Feet Road Width = 20 % Premium FSI • 40 – 60 Feet
        Road Width = 30 % Premium FSI • 60 Feet Road Width = 40 % Premium FSI If
        your land is located next to 30-40 feet roadway the you can avail a
        premium FSI of 20%,thus you can build 20% more than the allowable FSI of
        your city. Example: If your plot area is 1200 sqft. and the FAR allowed
        in your city is 1.5% then your total built up area cannot exceed
        1200x1.5= 1800 sqft. But if your plot in next to 30ft roadway you can
        avail extra 20% by paying the fees of premium FSI and now your total
        built up area can be Built-up area = Plot area x Normal FSI x Premium
        FSI 1200x1.5x1.2 =2160 sqft. Thus after availing premium FSI you can get
        a total built up area of 2160 sqft.
      </>
    ),
=======
...
>>>>>>> ac1c90507f717364e28eeb5d0dfad517a39a00d3
  ...
  },
  {
    ...
    blog: <>  <b>Types of Drawings needed in Construction</b>
     ...
     <b>i)Site Plan</b>
     <br/>
    A site plan shows property boundaries and means of access to the site, and nearby structures if they are relevant to the design. It represents the location, orientation and information about the site and gives the details of scope of work. It gives details of existing  structures,roads,water supply line, sewer line, drainage and other details which are located adjacent to site.
    <br/>
   <br/>
   <b>ii)Floor Plan</b>
   <br/>
Floor plan gives the details of horizontal dimensions of the building, thickness of walls, clear spaces inside the building and column locations. It also shows the openings required in the building such as doors, windows and ventilators
 <br/>
   <br/>
   <b>iii)Section Drawings</b>
   <br/>
   Section drawings give the details of vertical dimensions of the building. It gives details of various levels of the building. Its represents the drawing when the building is cut through a vertical plane
   <br/>
   <br/>
   <b>iv)Elevation Drawings</b>
   <br/>
   Elevation drawing gives the details of external appearance of the building, the details of openings, size and shape of external surface, height of building and finish of the building after completion
   <br/>
   <br/>
   <b>2. Structural Drawings</b>
   <br/>
   Structural drawings gives the details of how the structure will be built. These drawings give the dimensional details and reinforcement details of load carrying members of the building. Structural drawings set have different subsets as General Notes, excavation details, foundation details, and beam and column details, Slab details of the building.
   <br/>
   <br/>
   <b>i)General Notes</b>
   <br/>
   General Notes are part of structural drawings and they cover the codes used in design and the by-laws of the building. The general notes do not have any drawing but they have details about the grade of concrete, grade of steel, lap length to be given in columns and beams, cover to be used and other details in the structural members of the building.
   <br/>
   <br/>
   <b>ii)Excavation Drawings</b>
   <br/>
   Excavation drawing contains details of footing plan, columns layout, and grid lines of the columns
   <br/>
   <br/>
   <b>iii)Column Layout</b>
   <br/>
   Column layout drawings have the details of position and orientation of columns.These drawing have details of dimension of columns and also the reinforcement details to be used in the columns
   <br/>
   <br/>
   <b>iv)Plinth beam Layout</b>
   <br/>
   Plinth beam layout drawings have the details of position and section of plinth beams. These drawing have details of dimension and reinforcement to be used in the plinth beams.
   <br/>
   <br/>
   <b>v)Roof beam Layout</b>
   <br/>
   Roof beam layout drawings have the details of position and section of top beams. These drawing have dimensional and reinforcement details of top beams.
   <br/>
   <br/>
   <b>vi)Slab Layout</b>
   <br/>
   Slab layout drawings have the details of type of slab if one way or two way, openings in the slab and the reinforcement details of the slab.
   <br/>
   <br/>
   <b>3.MEP Drawings</b>
   <br/>
   MEP drawings have the details of mechanical, electrical and plumbing services to be installed in the projects.
   <br/>
   <br/>
   <b>i) Mechanical Drawings</b>
   <br/>
   Mechanical drawings have the details of HVAC and other mechanical equipment which are to be installed in the project. HVAC drawings specify the location and installation details of all heating, cooling and ventilation equipment. They also provide the layout for sheet metal ducts used in air distribution systems
   <br/>
   <br/>
   <b>ii) Electrical Drawings</b>
   <br/>
   An electrical drawing have details of single line diagrams of power, lightning and communication system for the project. Electrical drawing gives the details of electrical fixtures, location of switches, fan, light and others. It also represents the load calculation, tapping for electricity, wiring path and other interventions such as AC and UPS and its components.
   <br/>
   <br/>
   <b>iii) Plumbing Drawings</b>
   <br/>
   Plumbing drawings give the details of system of piping for fresh water going into the building and waste going out, both solid and liquid. Water supply drawing have details of hot water piping and cold water piping.
   <br/>
  These drawings also have the details of firefighting system to be installed in the building. These drawings have details of pumps and sumps to be installed in the project
  <br/>
   <br/>
   <b>4.Finishing Drawings</b>
   <br/>
   These drawings have the details of internal finishing of the building. Finishing drawings include flooring layout, false ceiling layout. These drawings also contains specifications of paint, plaster, type of flooring and other interior details of the building.
   <br/>
   <br/>
   <b>5.Landscaping Drawings</b>
   <br/>
   Landscaping drawing give the details of planning, designing and managing of open spaces in the project. It has details of the types of shrubs, flowers which are to be grown in the open spaces of the project.
   <br/>
   <br/>
    </>,
  },
